...
void CGRAPHIC::DrawNumber(int num, int first_x, int first_y, int txtColor, int bgdColor) {
	vector<int> arrNum{};
	for (; num != 0; num /= 10)
...
void CGRAPHIC::DrawDinasourPicture(int first_x, int first_y)
{
...
void CGRAPHIC::drawTag(int first_x, int first_y, string tagName, int tagColor) {
	...
	screen[first_x + 5][first_y + 1].txtColor = tagColor;
