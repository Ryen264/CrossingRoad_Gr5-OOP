#include "CTRAIN.h"
CTRAIN::CTRAIN(int x, int y, bool isRight, bool isHead) : COBJECT(x, y) {
...
bool CTRAIN::getIsRight() const
{
	return isRight;
}
bool CTRAIN::getIsHead() const
{
	return isHead;
}

void CTRAIN::setIsRight(bool isRight)
{
...
void CTRAIN::setIsHead(bool isHead)
{
	this->isHead = isHead;
